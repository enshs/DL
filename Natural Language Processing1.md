...
WordNet은 또한 좌표 용어, 파생어, 감각 등에 대한 정보를 제공합니다. 두 단어 사이의 유사점을 찾는 데 사용됩니다. 또한 관련 단어의 결과에 대한 정보도 보유합니다. 간단히 말해서 사전이나 시소러스로 취급할 수 있습니다. 워드넷으로 더 깊이 들어가면 다음과 같이 총 4개의 서브넷으로 나뉩니다. 
- 명사 
- 동사 
- 형용사 
- 부사 
